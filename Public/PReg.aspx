...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:UpdatePanel ID="upRegistration" runat="server">
        <ContentTemplate>
            <nav aria-label="Page breadcrumb" class="d-none">
            ...
            <div class="d-flex flex-column min-vh-100">
                <div class="container" style="margin-top: 40px; margin-bottom: 20px">
                    <h1 class="py-4" style="font-size: 40px; font-weight: bold;">Welcome</h1>
                    <div class="row">
                        <div class=" col-md-3 mb-3">
                            <div class="card">
                                <div class="card-body">
                                    <admission-page></admission-page>
                                </div>
                            </div>
                        </div>
                        <div class=" col-md-9">
                            <div class="card">
                                <div class="card-body">
                                    <p class="py-2">Fill in below information to get the control number for admission payments.</p>
                                    <admission-form 
                                        school-name-client-id='<%= ddlSchool.ClientID %>'
                                        academic-year-client-id='<%= ddlAcademic.ClientID %>'
                                        class-group-client-id='<%= ddlClass.ClientID %>'
                                        index-no-client-id='<%= txtADN.ClientID %>'
                                        student-name-client-id='<%= txtFN.ClientID %>'
                                        parent-name-client-id='<%= txtPN.ClientID %>'
                                        parent-mobile-client-id='<%= txtPM.ClientID %>'
                                        parent-email-client-id='<%= txtPE.ClientID %>'
                                        submit-form-button-client-id='<%= btnReg.ClientID %>'
                                        cancel-form-button-client-id='<%= btnCancel.ClientID %>'
                                    ></admission-form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-9">
                        <div class="card" style="margin-left: 5%; margin-right: 5%; margin-top: 40px; ">
                            <div class="card-body">       
                                ...
                                <div class="card-header"  style="background-color: #f26f21; color: white; margin-bottom: 10px; border-radius: 20px;">
                                ...
                                <div style="display: none !important" class="form-group d-flex justify-content-end d-none">
                ...
                <%-- <div class="container">
                    <div class="row">
                        <div class="card col-12 col-md-4 my-2">
                            <div class="card-body">
                                <admission-page></admission-page>
                            </div>
                        </div>
                ...
                <div class="footer text-center mt-auto w-100">
