<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AFeeAlloc.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="PresentationLayer.Facili.AFeeAlloc" %>
        ...
        <ContentTemplate>
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Admission Fee</li>
                </ol>
            </nav>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Admission Fee</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            <asp:Label CssClass="col-md-3 col-form-label pl-0" runat="server" ID="lblPB">Fee
                                <span class="red_new">*</span>
                            </asp:Label>
                        ...
                        <asp:GridView ID="Gridview1" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Class">
                                    <ItemTemplate>
                                        <asp:DropDownList CssClass="form-control mw-250px" runat="server" ID="ddlClass"
                                            AppendDataBoundItems="true">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator runat="server" ID="rfvFee" CssClass="red_new"
                                            Display="Dynamic" ControlToValidate="ddlClass"
                                            ErrorMessage="Please select types"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Currency">
                                    <ItemTemplate>
                                        <asp:DropDownList CssClass="form-control mw-250px" runat="server" ID="ddlCurrency"
                                            AppendDataBoundItems="true">
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator runat="server" ID="rfvTerm" CssClass="red_new"
                                            Display="Dynamic" ControlToValidate="ddlCurrency"
                                            ErrorMessage="Please select Currency"></asp:RequiredFieldValidator>
                                    </ItemTemplate>
                                </asp:TemplateField>
                    ...
                    <div class="form-group d-flex justify-content-end">
                        ...
                        <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" ID="btnReg" runat="server" Text="Submit"
