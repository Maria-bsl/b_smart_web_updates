<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassRetInb.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.ClassRetInb" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Classes Return Inbox</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Classes Return Inbox</h5>
                        ...
                        <div class="form-group d-flex justify-content-end">
                            ...
                            <asp:Button CssClass="btn btn-sm btn-biz_logic mr-1" runat="server" ID="btnCancel" Visible="false"
