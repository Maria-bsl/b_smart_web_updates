<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AllocApp.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.AllocApp" %>
    ...
    <div>
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Allocation Approve/Return</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Allocation Approve/Return</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-140">
                                ...
                                <asp:DropDownList CssClass="col-md-9 form-control" runat="server" ID="ddlAmount" Enabled="false">
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-140">
                                ...
                                <asp:DropDownList CssClass="col-md-9 form-control" runat="server" ID="ddlFANO" Enabled="false">
                                </asp:DropDownList>
