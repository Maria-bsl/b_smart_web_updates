<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Faci.Master" AutoEventWireup="true" CodeBehind="B_Det_Report.aspx.cs" Inherits="Schools.Facili.B_Det_Report" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Book Details Report</li>
                    </ol>
                </nav>
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Book Details Report</h5>

                        <div class="form-group col-md-6 row mx-0">
                            <label class="col-md-3 col-form-label pl-0">Select Subject</label>
                            <asp:DropDownList CssClass="col-md-9 form-control" runat="server" ID="ddlsub" >
