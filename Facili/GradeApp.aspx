<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeApp.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.GradeApp" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Score Grade Approve/Return</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <h5 class="card-title">Score Grade Approve/Return</h5>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            ...
                            <asp:TextBox CssClass="col-md-9 form-control" ID="txtGrade" runat="server" MaxLength="50" Enabled="false">
                            </asp:TextBox>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            ...
                            <asp:TextBox CssClass="col-md-9 form-control" ID="txtGfrom" runat="server" Enabled="false">
                            </asp:TextBox>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            ...
                            <asp:TextBox CssClass="col-md-9 form-control" ID="txtGto" runat="server" Enabled="false"></asp:TextBox>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            ...
                            <asp:RadioButtonList CssClass="col form-check form-check-inline mx-0 asp-radioButtonList" Enabled="false"
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            ...
                            <asp:DropDownList CssClass="col-md-9 form-control" runat="server" ID="ddlResult" Enabled="false">
                                <asp:ListItem class="asp-listItem col-form-label" Value="Pass">Pass</asp:ListItem>
                    ...
                    <div class="form-group d-flex justify-content-end">
                        ...
                        <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" ID="btnUpdate" runat="server" Text="Return" OnClientClick="return confirm('Are you sure you want to return?');"
                            OnClick="btnUpdate_Click"  />
                        <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" runat="server" ID="btnCancel"
                            CausesValidation="false" OnClick="btnCancel_Click" Text="Cancel" Visible="false" />
                    </div>
