<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Faci.Master" AutoEventWireup="true" CodeBehind="Veh_d_r_a_master.aspx.cs" Inherits="Schools.Facili.Veh_d_r_a_master" %>
            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="form-group col-md-6 row mx-0 format-140">
                        <label class="col-md-3 col-form-label pl-0">Vehicle Registration No/Plate No<span
                            ...
                            <asp:TemplateField HeaderText="Pick up Time">
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvatime" runat="server" CssClass="red_new"
                                        ErrorMessage="Please enter pick up Time" Display="Dynamic"
                            ...
                            <asp:TemplateField HeaderText="Drop off Time">
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvdtime" runat="server" CssClass="red_new"
                                        ...
                                        ErrorMessage="Please enter drop off Time">
                                    </asp:RequiredFieldValidator>
                            ...
                            <asp:TemplateField HeaderText="Landmark Picked">
                                <ItemTemplate>
                                    ...
                                    <asp:RequiredFieldValidator ID="rfvland" runat="server" ControlToValidate="txtland"
                                        CssClass="red_new" Display="Dynamic" ErrorMessage="Please enter land">
                                    </asp:RequiredFieldValidator>
