<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Setup_Subject.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.Setup_Subject" %>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Subject_Status" HeaderText="Status" />
