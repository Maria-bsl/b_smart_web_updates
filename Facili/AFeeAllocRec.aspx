<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AFeeAllocRec.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="PresentationLayer.Facili.AFeeAllocRec" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Admission Fee Return</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Admission Fee Return</h5>
                            ...
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Currency">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTer" runat="server" Text='<%#Eval("Currency_Code") %>'>
                                            </asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
