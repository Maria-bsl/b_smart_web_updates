<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassApp.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.ClassApp" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Class Approve/Return</li>
                </ol>
            </nav>

            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Class Approve/Return</h5>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-100">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red_new offset-md-3"
                                ControlToValidate="txtRegion" Display="Dynamic" ErrorMessage="Please enter class">
                            </asp:RequiredFieldValidator>
                        </div>
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-100">
                            <label class="col-md-3 col-form-label pl-0">Uplift Class:</label>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-100">
                            ...
                            <asp:RadioButtonList RepeatLayout="Flow" CssClass="col form-check form-check-inline mx-0"
                                ...
                                <asp:ListItem class="asp-listItem col-form-label mr-3" Value="Active" Selected="True" Enabled="false">
                                    Active</asp:ListItem>
