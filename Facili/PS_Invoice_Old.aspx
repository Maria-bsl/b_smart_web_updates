<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PS_Invoice_Old.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.PS_Invoice_Old" %>
                ...
                <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Upload Date">
                            ...
                            <EditItemTemplate>
                                <asp:TextBox CssClass="Displaytext form-control" ID="txtUDate" runat="server" Text='<%#Convert.ToDateTime(Eval("Upload_Date")).ToString("MM/dd/yyyy") %>'>
                            </asp:TextBox>
                            <div class="input-group-append rounded-right">
                                <asp:ImageButton CssClass="input-group-text" runat="server" CausesValidation="false"
                                    ID="iPopupU" ImageUrl="/images/calendar.png" height="38px" />
                            </div>
                                    <ajaxToolkit:CalendarExtender ID="CalendarU" runat="server" PopupButtonID="iPopupU"
                                TargetControlID="txtUDate" Format="MM/dd/yyyy"></ajaxToolkit:CalendarExtender><br />
                            <asp:RequiredFieldValidator runat="server" ID="rfvUDate" ControlToValidate="txtUDate"
                                Display="Dynamic" CssClass="red_new offset-md-3" ErrorMessage="Please select upload date">
                            </asp:RequiredFieldValidator>
                           <%-- <asp:comparevalidator ID="cmpUDate" runat="server" Display="Dynamic"
                                errormessage="The date must be greater than equal to today date" CssClass="red_new offset-md-3"
                                valuetocompare="<%# DateTime.Today.ToShortDateString() %>" controltovalidate="txtUDate"
