<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuAct.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.StuAct" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Students Activation Inbox</li>
                </ol>
            </nav>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Students Activation Inbox</h5>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:CommandField ShowDeleteButton="true" HeaderText="Activate" DeleteText="Activate" />
                            </Columns>
                        </asp:GridView>
                    </div>
