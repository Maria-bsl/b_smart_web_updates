<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupClass.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.SetupClass" %>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="UClass_Name" HeaderText="Uplift Class" />
                                <asp:BoundField DataField="Class_Status" HeaderText="Status" />
