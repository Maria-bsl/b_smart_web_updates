<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ClassUpd.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.ClassUpd" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Class Update</li>
                </ol>
            </nav>

            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Class Update</h5>
                    ...
                    <div class="form-group d-flex justify-content-end">
                        ...
                        <asp:Button CssClass="btn btn-sm btn-biz_logic ml-1" ID="btnUpdate" runat="server" Text="Return"
                         OnClientClick="return confirm('Are you sure you want to return?');"   OnClick="btnUpdate_Click" Visible="false" />
