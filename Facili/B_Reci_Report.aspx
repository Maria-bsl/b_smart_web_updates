<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Faci.Master" AutoEventWireup="true" CodeBehind="B_Reci_Report.aspx.cs" Inherits="Schools.Facili.B_Reci_Report" %>
            ...
            <ContentTemplate>
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Book Receive Report</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Book Receive Report</h5>
                        <div class="row">
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-150">
                                <label class="col-sm-3 col-form-label pl-0">Receive From Date</label>
                            ...
                            <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-150">
                                <label class="col-sm-3 col-form-label pl-0">Recieve To Date</label>
                                <div class="col-sm-9 input-group px-0">
