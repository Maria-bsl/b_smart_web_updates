<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GradeRetInb.aspx.cs" MasterPageFile="~/Head_Faci.Master" Inherits="Schools.Facili.GradeRetInb" %>
            ...
            <ContentTemplate>
                ...
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Score Grade Return Inbox</li>
                    </ol>
                </nav>

                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Score Grade Return Inbox</h5>
                        ...
                        <div class="form-group d-flex justify-content-end">
                            <asp:Button CssClass="btn btn-sm btn-biz_logic " ID="btnSubmit" runat="server"
                                Text="Approve All" OnClientClick="return confirm('Are you sure you want approve all');"
