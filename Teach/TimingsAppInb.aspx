<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Teach.Master" AutoEventWireup="true" CodeBehind="TimingsAppInb.aspx.cs" Inherits="Schools.Teach.TimingsAppInb" %>
            ...
            <ContentTemplate>
                <nav aria-label="Page breadcrumb">
                    <ol class="breadcrumb mb-1 bg-white py-1 border">
                        ...
                        <li class="breadcrumb-item">Timings Approval Inbox</li>
                    </ol>
                </nav>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">
                            <asp:Label runat="server" ID="lblInbox" CssClass="hd1">Timings Approval Inbox
                            </asp:Label>
                        </h5>
