<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangePassword.aspx.cs" MasterPageFile="~/Head_Teach.Master" Inherits="Schools.Teach.ChangePassword" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning alert-dismissible fade show" role="alert">
                            ...
                            <!--<strong>
                                <asp:Label runat="server" ID="Label1">Your password hasn't changed until 90
                                    days, please change your password.</asp:Label>
                            </strong>-->
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-8 row mx-0">
                                <label class="col-md-4 col-form-label pl-0">Current Password
                                    <span class=" red_new">*</span>
                                </label>
                                <asp:TextBox CssClass="col-md-8 form-control" runat="server" ID="txtCurrent"
                                    TextMode="Password"  MaxLength="100"></asp:TextBox>
                                <asp:RequiredFieldValidator runat="server" ID="rfvCurrent"
                                    CssClass="red_new offset-md-4" ControlToValidate="txtCurrent" Display="Dynamic"
                                    ErrorMessage="Please enter current password">
                                </asp:RequiredFieldValidator>
                            </div>
                            <div class="form-group col-md-8 row mx-0">
                                <label class="col-md-4 col-form-label pl-0">New Password
                                    <span class="red_new">*</span>
                                </label>
                            ...
                            <div class="form-group col-md-8 row mx-0">
                                <label class="col-md-4 col-form-label pl-0">Confirmation Password
                                    <span class="red_new">*</span>
                                </label>
