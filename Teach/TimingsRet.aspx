<%@ Page Title="" Language="C#" MasterPageFile="~/Head_Teach.Master" AutoEventWireup="true" CodeBehind="TimingsRet.aspx.cs" Inherits="Schools.Teach.TimingsRet" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title"><label class="hd1">Period Timings</label></h5>
                            ...
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Period Type">
                                        <ItemTemplate>
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvPeriod" runat="server"
                                                ControlToValidate="ddlPeriod" CssClass="red_new offset-md-3" Display="Dynamic"
                                    ...
                                    <asp:TemplateField HeaderText="Start Time">
                                        <ItemTemplate>
                                            <asp:TextBox CssClass="col-md-9 form-control" ID="txtStart" runat="server"
                                                htmlencode="false" placeholder="HH:MM" MaxLength="5"
                                                Text='<%#Eval("Start_Time") %>' onkeypress="formatTime(this)"
                                                DataFormatString="{0:hh:mm}">
                                            </asp:TextBox>
                                            <asp:RegularExpressionValidator ID="revstart" runat="server"
                                                CssClass="red_new offset-md-3" Display="Dynamic" SetFocusOnError="true"
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvStart" runat="server"
                                                ControlToValidate="txtStart" CssClass="red_new offset-md-3" Display="Dynamic"
                                    ...
                                    <asp:TemplateField HeaderText="End Time">
                                        <ItemTemplate>
                                            <asp:TextBox CssClass="col-md-9 form-control" ID="txtEnd" runat="server"
                                            ...
                                            <asp:RequiredFieldValidator ID="rfvEnd" runat="server"
                                                ControlToValidate="txtEnd" CssClass="red_new offset-md-3" Display="Dynamic"
