<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupZone.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.SetupZone" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-120">
                            <label class="col-md-3 col-form-label pl-0">Zone Name</label>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Zone_Status" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
