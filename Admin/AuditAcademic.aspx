<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditAcademic.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.AuditAcademic" %>
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="AcademicSno" HeaderText="Academic Sno" />
