<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupBranch.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupBranch" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Bank Branches</li>
                </ol>
            </nav>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-110">
                            <label class="col-md-3 col-form-label pl-0">Branch Name</label>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-110">
                            ...
                            <asp:RadioButtonList
                                CssClass="col-md-9 form-check form-check-inline mx-0 asp-radioButtonList"
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-110">
                            ...
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtLoc"
                                MaxLength="100">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvSector" CssClass="red_new offset-md-3"
                                Display="Dynamic" ControlToValidate="txtLoc" ErrorMessage="Please enter location">
                            </asp:RequiredFieldValidator>
                        </div>
    
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-110">
                            <label class="col-md-3 col-form-label pl-0">City</label>
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtCity"
                                MaxLength="100">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvCity" CssClass="red_new offset-md-3"
                                Display="Dynamic" ControlToValidate="txtCity" ErrorMessage="Please enter city">
                            </asp:RequiredFieldValidator>
                        </div>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Fee_Status" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
