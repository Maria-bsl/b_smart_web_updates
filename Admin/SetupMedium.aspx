<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupMedium.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupMedium" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">Medium</li>
                </ol>
            </nav>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                            <label class="col-md-3 col-form-label pl-0">Medium</label>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MediumSno" HeaderText="Sector ID" ShowHeader="false">
                                    <ItemStyle CssClass="hide" />
                                    <HeaderStyle CssClass="hide" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Medium_Status" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
