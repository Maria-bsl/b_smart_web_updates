<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupDesignation.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.SetupDesignation" %>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-100">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red_new offset-md-3"
                                ...
                                ErrorMessage="Please enter designation"></asp:RequiredFieldValidator>
                        </div>
