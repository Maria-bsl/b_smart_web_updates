<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupFee.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupFee" %>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-125">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red_new offset-md-3"
                                ...
                                ErrorMessage="Please enter fee type"></asp:RequiredFieldValidator>
                        </div>
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-125">
                            <label class="col-md-3 col-form-label pl-0">Fee Description</label>
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvSector" CssClass="red_new offset-md-3"
                                Display="Dynamic" ControlToValidate="txtSwift"
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="FeeSno" HeaderText="Sector ID" ShowHeader="false">
                                    <ItemStyle CssClass="hide" />
                                    <HeaderStyle CssClass="hide" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Fee_Desc" HeaderText="Description" />
