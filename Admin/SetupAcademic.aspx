<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupAcademic.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupAcademic" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                            <label class="col-md-3 col-form-label pl-0">Academic</label>
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red_new offset-md-3"
                                ControlToValidate="txtRegion" Display="Dynamic" ErrorMessage="Please enter Academic">
                            </asp:RequiredFieldValidator>
                        </div>

                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                            <label class="col-auto col-form-label pl-0">Status</label>
                            <asp:RadioButtonList CssClass="col asp-radioButtonList px-0" RepeatDirection="Horizontal"
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="AcademicSno" HeaderText="Sector ID" ShowHeader="false">
                                    <ItemStyle CssClass="hide" />
                                    <HeaderStyle CssClass="hide" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Academic_Status" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
                    </div>
                </div>
