<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditDesignation.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.AuditDesignation" %>
    ...
    <div>
        <asp:UpdatePanel ID="upRegister" runat="server">
            <ContentTemplate>
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Designation</h1>
                            ...
                            <div class="row">
                                <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-90">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="rfvFDate"
                                        ControlToValidate="txtFDate" Display="Dynamic" CssClass="red_new"
                                    ...
                                    <asp:comparevalidator ID="cmpFDate" runat="server" Display="Dynamic"
                                        ...
                                        CssClass="red_new" valuetocompare="<%# DateTime.Today.ToShortDateString() %>"
                                ...
                                <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-90">
                                    ...
                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1"
                                        ControlToValidate="txtTDate" Display="Dynamic" CssClass="red_new"
                                        ErrorMessage="Please select to date">
                                    </asp:RequiredFieldValidator>
                                    <asp:CompareValidator ID="cmpVal" ControlToCompare="txtFDate"
                                        ControlToValidate="txtTDate" Display="Dynamic" CssClass="red_new" Type="Date"
