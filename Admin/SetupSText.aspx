<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupSText.aspx.cs" ValidateRequest="false" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupSText" %>
        ...
        <ContentTemplate>
            ...
            <nav aria-label="Page breadcrumb">
                <ol class="breadcrumb mb-1 bg-white py-1 border">
                    ...
                    <li class="breadcrumb-item">SMS Text</li>
                </ol>
            </nav>
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">SMS Text</h5>

                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-7 row mx-0 format-85">
                            <label class="col-md-3 col-form-label pl-0">Instance</label>
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvFlow" CssClass="red_new" Display="Dynamic"
                                ErrorMessage="Please select instance" ControlToValidate="ddlFlow">
                        ...
                        <div class="form-group col-sm-11 col-md-9 col-lg-7 row mx-0 format-85">
                            <label class="col-md-3 col-form-label pl-0">Message</label>
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtDays"
                                TextMode="MultiLine" Rows="5" Width="750px" Columns="30"></asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvDays" CssClass="red_new"
