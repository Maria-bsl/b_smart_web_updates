<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditMedium.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.AuditMedium" %>
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="MediumSno" HeaderText="Medium Sno" />
