<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupIP.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupIP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div>
        ...
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">IP Adress</h5>

                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-145">
                            <label class="col-md-3 col-form-label pl-0">IP Address</label>
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtIP" MaxLength="100">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red_new offset-md-3"
                                ControlToValidate="txtIP" Display="Dynamic" ErrorMessage="Please enter ip address">
                            </asp:RequiredFieldValidator>
                        </div>

                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-145">
                            <label class="col-md-3 col-form-label pl-0">Payment Channel</label>
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtCH" MaxLength="100">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvSector" CssClass="red_new offset-md-3"
                                Display="Dynamic" ControlToValidate="txtCH"
                                ErrorMessage="Please enter payment channel name"></asp:RequiredFieldValidator>
                        </div>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="IP_ADD" HeaderText="IP Address" />
                                <asp:BoundField DataField="SNO" HeaderText="SNO" ShowHeader="false">
                                    <ItemStyle CssClass="hide" />
                                    <HeaderStyle CssClass="hide" />
                                </asp:BoundField>
                                <asp:BoundField DataField="CH_Name" HeaderText="Payment Channel" />
