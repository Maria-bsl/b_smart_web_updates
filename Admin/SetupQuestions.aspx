<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupQuestions.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.SetupQuestions" %>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-90">
                            <label class="col-md-3 col-form-label pl-0">Questions</label>
                            <asp:TextBox CssClass="col-md-9 form-control" runat="server" ID="txtVeh" MaxLength="100">
                            </asp:TextBox>
                            <asp:RequiredFieldValidator runat="server" ID="rfvVeh" CssClass="red_new offset-md-3"
                                ControlToValidate="txtVeh" Display="Dynamic" ErrorMessage="Please enter question">
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Ques_Name" HeaderText="Question" />
