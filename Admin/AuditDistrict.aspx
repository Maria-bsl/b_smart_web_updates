<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuditDistrict.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="PresentationLayer.Admin.AuditDistrict" %>
                        ...
                        <div class="table-responsive mb-1">
                            <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="DistrictSno" HeaderText="District Sno" />
