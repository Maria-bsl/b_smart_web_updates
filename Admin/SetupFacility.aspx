<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupFacility.aspx.cs" MasterPageFile="~/Head_Admin.Master" Inherits="Schools.Admin.SetupFacility" %>
                    ...
                    <div class="row">
                        <div class="form-group col-sm-11 col-md-9 col-lg-6 row mx-0 format-85">
                            ...
                            <asp:RequiredFieldValidator runat="server" ID="rfvDept" CssClass="red_new offset-md-3"
                                ...
                                ErrorMessage="Please enter facility"></asp:RequiredFieldValidator>
                        </div>
                    ...
                    <div class="table-responsive mb-1">
                        <asp:GridView ID="gvDept" CssClass="table table-bordered mb-1 display" runat="server"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="Facility_Type" HeaderText="Facility" />
                                <asp:BoundField DataField="FacilitySno" HeaderText="Sector ID" ShowHeader="false">
                                    <ItemStyle CssClass="hide" />
                                    <HeaderStyle CssClass="hide" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Facility_Status" HeaderText="Status" />
                            </Columns>
                        </asp:GridView>
